...
public enum Constants {
    ...
    IS_RENTED("IsRented"),
    FIND_ALL_QUERY("SELECT Id, Maker, Model, Year, Color, LicensePlate, DailyPrice, IsRented FROM Cars ORDER BY Id"),
    FIND_BY_ID_QUERY("SELECT Id, Maker, Model, Year, Color, LicensePlate, DailyPrice, IsRented FROM Cars WHERE Id = ?"),
    SAVE_QUERY("INSERT INTO Cars (Maker, Model, Year, Color, LicensePlate, DailyPrice, IsRented) VALUES (?, ?, ?, ?, ?, ?, ?)"),
    UPDATE_QUERY("UPDATE Cars SET Maker = ?, Model = ?, Year = ?, Color = ?, LicensePlate = ?, DailyPrice = ?, IsRented = ? WHERE Id = ?"),
